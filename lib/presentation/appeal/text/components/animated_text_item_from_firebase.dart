...
class AnimatedTextItemFromFirebase extends StatefulWidget {
  final String text;

  const AnimatedTextItemFromFirebase({
    Key? key,
    required this.text, // 引数に遅延時間を追加
  }) : super(key: key);

  @override
  _AnimatedTextItemFromFirebaseState createState() =>
      _AnimatedTextItemFromFirebaseState();
}

class _AnimatedTextItemFromFirebaseState
    extends State<AnimatedTextItemFromFirebase>
